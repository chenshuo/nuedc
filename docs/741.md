...
µA747 / MC1458 / MC1558 是 741 的双运放版本，电路特性是一样的。Raytheon 的 [RC4558](/rc4558/) 是一款一度非常流行的[廉价](http://www.bitsavers.org/magazines/The_Electronic_Engineer/The_Electronic_Engineer_V31_N12_197212.pdf)集成双运放，[电路比 741 略微简单一些](741/rc4558.png)，其性能指标和 µA741 相仿，带宽 3MHz。[1974 年上市](https://www.learningelectronics.net/VA3AVR/gadgets/741/741.html)的 LM324 是集成四运放，连同其双运放版 LM358 至今是十分流行的器件，我怀疑 LM358 可能是目前销量最大的运放。
