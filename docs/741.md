...
* \(V_\mathrm{BE17} = V_\mathrm{T}\ln\dfrac{I_\mathrm{E17}}{I_\mathrm{S}}=25.8\times \ln \dfrac{552\times 10^{-6} (1+\beta)}{ 10^{-14}\beta} = 638\) mV, \(V_\mathrm{B17} - V_\mathrm{EE}= V_\mathrm{BE17} + I_\mathrm{E17}\,R_8 = 694\)mV
...
* 先估算 \(V_\mathrm{CE19}=V_\mathrm{BE18} + V_\mathrm{BE19}\)
